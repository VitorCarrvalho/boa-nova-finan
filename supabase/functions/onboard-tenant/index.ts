...
const defaultProfiles = [
  ...
  {
    name: 'Analista',
    description: 'Visualização de contas a pagar e relatórios',
    permissions: {
      dashboard: { view: true, export: true },
  ...
  {
    name: 'Presidente',
    description: 'Acesso a todos os módulos e ações',
    permissions: {
      dashboard: { view: true, export: true },
      membros: { view: true, insert: true, edit: true, delete: true, export: true },
      congregacoes: { view: true, insert: true, edit: true, delete: true, export: true },
  ...
  {
    name: 'Diretor',
    description: 'Perfil para diretores com poder de aprovação',
    permissions: {
      dashboard: { view: true, export: true },
      membros: { view: true, insert: true, edit: true, delete: false, export: true },
      ...
      'gestao-acessos': { view: true, insert: true, edit: true, delete: false, approve: true },
